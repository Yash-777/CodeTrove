...
export default function App() {
  return <BrowserRouter><Routes><Route element={<AppLayout />}>
    ...
    <Route path="/build/compiler" element={<CompilerPage />} /><Route path="/build/tools" element={<ToolsPage />} /><Route path="/build/tools/jwt-tool" element={<JwtToolPage />} /><Route path="/build/projects" element={<RequireRole allow={ANY_LOGGED_IN}><ProjectsPage /></RequireRole>} />
    <Route path="/store/profile" element={<RequireRole allow={ANY_LOGGED_IN}><ProfilePage /></RequireRole>} /><Route path="/store/resume" element={<RequireRole allow={ANY_LOGGED_IN}><ResumePage /></RequireRole>} /><Route path="/store/certificates" element={<RequireRole allow={ANY_LOGGED_IN}><CertificatesPage /></RequireRole>} /><Route path="/store/career" element={<RequireRole allow={ANY_LOGGED_IN}><CareerPage /></RequireRole>} />
    <Route path="/signup" element={<SignUpPage />} /><Route path="/signin" element={<SignInPage />} /><Route path="/admin/users" element={<RequireRole allow={['admin']}><UsersPage /></RequireRole>} /><Route path="/preferences" element={<Preferences />} /><Route path="*" element={<NotFound />} />
