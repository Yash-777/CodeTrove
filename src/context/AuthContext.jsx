...
//         `To keep Codetrove fast and fair for everyone, each account can be signed in on up to ${MAX_DEVICES} devices at a time. This account is already using its limit - sign out on another device first, or contact an admin.`
//       );
